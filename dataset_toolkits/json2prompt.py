...
def json_to_user_prompt(json_file):
    ...
    user_prompt = "Generate a commercial aircraft with the following specifications:\n"
...
if __name__ == "__main__":
    ...
    json_dir = "/fs-computility/ai-shen/wujianyu/T8/T8/json/T8_sample_001_params.json"
    json_dir = pathlib.Path(json_dir)
    print(f"{json2prompt(json_dir)!r}")
